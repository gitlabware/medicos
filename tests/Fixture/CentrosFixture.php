...
class CentrosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'centro_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'created' => '2015-07-12 04:39:53',
            'modified' => '2015-07-12 04:39:53',
            'centro_id' => 1
        ],
    ];
}
